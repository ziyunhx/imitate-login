...
namespace ImitateLogin
{
  ...
  public partial class Extension : TBase
  {
    ...
    private THashSet<LoginSite> _SupportSite;
    ...
    public THashSet<LoginSite> SupportSite
    {
      get
      {
        return _SupportSite;
    ...
    public void Write(TProtocol oprot) {
      ...
      if (SupportSite != null && __isset.SupportSite) {
        ...
        oprot.WriteFieldBegin(field);
        {
          oprot.WriteSetBegin(new TSet(TType.I32, SupportSite.Count));
          foreach (LoginSite _iter8 in SupportSite)
          {
